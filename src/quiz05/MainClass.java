...
public class MainClass {
	...
	public static void main(String[] args) {
		 ...
		 * rect메서드는 변의 길이를 입력받아
		 * 정사각형의 넓이, 직사각형의 넓이, 직육면체의 넓이를 반환하도록 오버로딩
		 */
		...
		System.out.println("컴퓨터:"+com.circle(5));
		
		System.out.println("정사각형:"+com.rect(4));
		System.out.println("직사각형:"+com.rect(4, 6));
		System.out.println("직육면체:"+com.rect(3, 4, 5));
